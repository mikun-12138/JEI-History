...
public class ExtendedFocusInputHandler implements IUserInputHandler {
    ...
    public ExtendedFocusInputHandler(CombinedRecipeFocusSource focusSource, IRecipesGui recipesGui, FocusUtil focusUtil, IClientConfig clientConfig, IIngredientManager ingredientManager, IClientToggleState toggleState, IConnectionToServer serverConnection) {
    ...
    private Optional<IUserInputHandler> handleShow(@NotNull UserInput userInput, List<RecipeIngredientRole> roles, IInternalKeyMappings iInternalKeyMappings) {
        return focusSource.getIngredientUnderMouse(userInput, iInternalKeyMappings)
